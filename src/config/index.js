export const __config = {
  production: {
    ...
    // 职位
    pinModulUrl: 'http://pin.65ph.com',
    // 项目
    projectModulUrl: 'http://project.65ph.com',
    // 商城
    storeModulUrl: 'http://www.65ph.com',
    // 学院
    collegeModulUrl: 'http://college.65ph.com',
    // 账户
    accountModulUrl: 'http://account.65ph.com/'
  },
  dev: {
    // 网站根目录
    ...
    // 职位
    pinModulUrl: 'http://pin.test.com:8080/#/',
    // 项目
    projectModulUrl: 'http://project.test.com:8181/#/',
    // 商城
    storeModulUrl: 'http://www.test.com:8282/#/',
    // 学院
    collegeModulUrl: 'http://college.test.com:8383/#/',
    // 账户
    accountModulUrl: 'http://account.test.com:8484/#/'
  }
}
