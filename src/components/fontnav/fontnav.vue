      ...
      <div class="content font-nav-content" v-if="activeIndex2 == ''">
        ...
        >
          ...
          <el-menu-item index="2" v-show="activeIndex == '1'">
            <router-link class="hk-nav-a" to="/">招商项目</router-link>
          </el-menu-item>
          <el-menu-item index="2" v-show="activeIndex !== '1'">
            <router-link class="hk-nav-a" to="/">项目中心</router-link>
          </el-menu-item>
          <el-menu-item index="2" v-show="activeIndex == '1'">
            <router-link class="hk-nav-a" to="/">环评公示</router-link>
          </el-menu-item>
          ...
          <el-submenu index="5">
            ...
            <el-menu-item index="5-1">
              <router-link class="hk-nav-a hk-rout-link-fb" to="/">水环境招聘</router-link>
            </el-menu-item>
            <el-menu-item index="5-2">
              <router-link class="hk-nav-a hk-rout-link-fb" to="/">招聘职位</router-link>
            </el-menu-item>
          </el-submenu>
          <el-menu-item index="6">
            <a class="hk-nav-a" :href="colegeUrl+'/front/college/recommend'">水环境学院</a>
          </el-menu-item>
        </el-menu>
        <!-- 右边导航 -->
        <topright></topright>
      ...
      <div v-if="activeIndex2 == '1'" class="my-resume-nav">
        <div class="nav-content">
          ...
          <div class="nav-select">
            ...
            <div class>
              <router-link to="/" tag="div">简历中心</router-link>
            </div>
          </div>
        </div>
      </div>
...
export default {
  data() {
    return {
      colegeUrl: 'http://college.test.com:8081',
      activeIndex: "1",
      activeIndex2: "",
      pageTitle: "项目中心",
